#!/usr/bin/env python3
"""
Simple test script for Balance Sheet Unsettled Entries functionality

This script should be run from the BACKEND/backend directory:
python test_balancesheet_simple.py

It tests that the balance sheet correctly includes unsettled entries from previous years
and properly discards fully settled entries.
"""
