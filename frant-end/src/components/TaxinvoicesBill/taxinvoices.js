                ...
                <div className="col-6">
                  <table className="table table-bordered black-bordered">
                    <tbody>
                      <tr>
                        <td>Invoice No.</td>
                        <td className="incoice-no-td">
                          <input style={{ margin: "10px" }} type="text" name="invoiceNumber" value={invoiceNumber} readOnly />
                        </td>
                      </tr>
                      <tr>
                        <td>Date</td>
                    ...
                    <tbody>
                      <tr style={{ height: '111px' }}>
                        ...
                        <td style={{ width: '130px' }}>
                          <select style={{ height: "46px" }} name="hns_select" id="hns_select" value={hnsSelect} onChange={e => setHnsSelect(e.target.value)}>
                        ...
                        <td style={{ width: '200px' }}><span className="currency-sym">{selectedCountry.symbol}</span> <input style={{ width: "150px" }} onChange={e => setBaseAmount(e.target.value)} value={baseAmount} id="baseAmount" name="baseAmount" type="number" /></td>
                      </tr>
                      {showInsideIndia && <>
                ...
                <div className="col-xs-12">
                  <div className="table-bordered black-bordered amount-box">
                    <div>
                      ...
                      <h4 id="total-in-words"><span className="currency-text">{selectedCountry.code}</span> {totalInWords}</h4>
                ...
                <div style={{ padding: '0 0 0 10px' }}>
                  ...
                  <div className="col-xs-12">
                    <div>
                      ...
                      <h5><input name="remark" type="text" className="remark" style={{ width: '550px' }} value={remark} onChange={e => setRemark(e.target.value)} /></h5>
                    </div>
                  </div>
                </div>
              </div>
